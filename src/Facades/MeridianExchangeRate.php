 ...
 * @method static float getRate(string $targetCurrencyCode, ?string $baseCurrencyCode = null, string|Carbon|null $date = null) Get the exchange rate between two currencies.
