...
interface ExchangeRateServiceContract
{
     ...
     * @param string|\Illuminate\Support\Carbon|null $date Date for rates ('latest' or YYYY-MM-DD). Defaults to 'latest'.
     ...
     * @param string|\Illuminate\Support\Carbon|null $date The date for the exchange rate. Defaults to latest.
     ...
     * @param \Illuminate\Support\Carbon|null $date The specific date for rates, or null for the latest rates.
